...
export function AssumptionsSection() {
  const sectionData = useDocumentStore(s => s.sections?.assumptions) as Record<string, any> | undefined
  ...
  if (!hasContent) {
    return (
      <div>
        ...
        <p style={{ color: '#999' }}>가정 및 리스크가 아직 정의되지 않았습니다. 채팅에서 "Assumptions 작성해줘"라고 요청하세요.</p>
      </div>
    )
  }
